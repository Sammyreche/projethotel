...
@RestController
@RequestMapping("/reservations/liste")
@CrossOrigin("*")
public class ListeReservationResource {
...
//	}
	...
	@GetMapping("")
	public List<ListeReservationDto> findAll() {
	...
	@GetMapping("/{id}")
	public ListeReservationDto findById(@PathVariable Integer id) {
	...
	public List<ListeReservationDto> findByKw(@PathVariable String kw) {
		List<ListeReservationDto>  listeReservatios = new ArrayList<>();
		System.out.println(kw);
		if (!kw.isBlank()) {
			
			for (Reservation resa : daoReservation.findBykw(kw)) {
				ListeReservationDto  listeReservationDto = new ListeReservationDto();;
				listeReservationDto.setId(resa.getId());
				listeReservationDto.setNom(resa.getClientPrincipal().getNom());
				listeReservationDto.setPrenom(resa.getClientPrincipal().getPrenom());
